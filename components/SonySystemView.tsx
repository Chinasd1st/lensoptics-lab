            ...
            <div className="overflow-x-auto rounded-lg border border-zinc-200 dark:border-zinc-800">
               <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-zinc-200 dark:divide-zinc-700 bg-zinc-100 dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300">
                     <tr className="hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800 transition-colors"><td className="p-3 font-mono text-zinc-900 dark:text-white">4K UHD</td><td className="p-3"><span className="text-primary-400 font-bold">XAVC S-I</span></td><td className="p-3 text-primary-500 dark:text-cyan-400">4:2:2 10-bit</td><td className="p-3">60p</td><td className="p-3 text-right font-mono">600</td></tr>
                     <tr className="hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800 transition-colors"><td className="p-3 font-mono text-zinc-900 dark:text-white">4K UHD</td><td className="p-3"><span className="text-primary-400 font-bold">XAVC S</span></td><td className="p-3 text-primary-500 dark:text-cyan-400">4:2:2 10-bit</td><td className="p-3">120p (100p)</td><td className="p-3 text-right font-mono">280</td></tr>
                     <tr className="hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800 transition-colors"><td className="p-3 font-mono text-zinc-900 dark:text-white">4K UHD</td><td className="p-3"><span className="text-primary-400 font-bold">XAVC S</span></td><td className="p-3 text-primary-500 dark:text-cyan-400">4:2:2 10-bit</td><td className="p-3">60p (50p)</td><td className="p-3 text-right font-mono">200</td></tr>
                     <tr className="hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800 transition-colors"><td className="p-3 font-mono text-zinc-900 dark:text-white">4K UHD</td><td className="p-3"><span className="text-green-400 font-bold">XAVC HS</span></td><td className="p-3 text-zinc-500 dark:text-zinc-400">4:2:0 10-bit</td><td className="p-3">120p (100p)</td><td className="p-3 text-right font-mono">200</td></tr>
                     <tr className="hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800 transition-colors"><td className="p-3 font-mono text-zinc-900 dark:text-white">4K UHD</td><td className="p-3"><span className="text-primary-400 font-bold">XAVC S</span></td><td className="p-3 text-primary-500 dark:text-cyan-400">4:2:2 10-bit</td><td className="p-3">30p / 24p</td><td className="p-3 text-right font-mono">140 / 100</td></tr>
                     <tr className="hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800 transition-colors"><td className="p-3 font-mono text-zinc-900 dark:text-white">4K UHD</td><td className="p-3"><span className="text-primary-400 font-bold">XAVC S</span></td><td className="p-3 text-zinc-500 dark:text-zinc-400">4:2:0 8-bit</td><td className="p-3">120p</td><td className="p-3 text-right font-mono">200</td></tr>
                     <tr className="hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800 transition-colors"><td className="p-3 font-mono text-zinc-900 dark:text-white">4K UHD</td><td className="p-3"><span className="text-primary-400 font-bold">XAVC S</span></td><td className="p-3 text-zinc-500 dark:text-zinc-400">4:2:0 8-bit</td><td className="p-3">30p / 24p</td><td className="p-3 text-right font-mono">100 / 60</td></tr>
                  </tbody>
               </table>
            </div>
            ...
            <div className="w-full max-w-4xl aspect-[3/2] bg-zinc-50 dark:bg-zinc-900 border-4 border-zinc-200 dark:border-zinc-800 rounded-lg relative flex overflow-hidden font-sans select-none shadow-lg">
               ...
               <div className="w-[10%] min-w-[50px] bg-zinc-50 dark:bg-zinc-900 flex flex-col items-center py-4 gap-4 border-r border-zinc-200 dark:border-zinc-800 shrink-0">
                  {menuStructure.map((m, i) => (
                     <div key={i} onClick={() => { setMainTab(i); setSubTab(0); }} className={`w-8 h-8 lg:w-10 lg:h-10 rounded flex items-center justify-center transition-colors cursor-pointer ${mainTab === i ? m.color + ' text-zinc-900 dark:text-white shadow-lg scale-110' : 'text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-100 dark:bg-zinc-800'}`}>{m.icon}</div>
                  ))}
               </div>
