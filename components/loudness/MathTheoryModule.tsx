...
export const MathTheoryModule: React.FC = () => {
   return (
      <div className="max-w-5xl mx-auto space-y-12 pb-12">
         {/* Introduction */}
          <div className="bg-zinc-100 dark:bg-zinc-900 p-8 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm">
             <h2 className="text-3xl font-bold text-zinc-900 dark:text-white mb-4 flex items-center gap-3">
                <Sigma size={32} className="text-primary-500"/> 为什么 LUFS ≠ RMS？
            </h2>
         ...
         <div className="bg-zinc-100 dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
            <div className="bg-zinc-100 dark:bg-zinc-800 p-4 border-b border-zinc-200 dark:border-zinc-800 flex justify-between items-center">
               <h3 className="font-bold text-zinc-900 dark:text-white flex items-center gap-2">ITU-R BS.1770 总纲公式</h3>
            </div>
             <div className="p-10 flex flex-col items-center justify-center bg-zinc-50 dark:bg-zinc-900">
               {/* Formula Render */}
               <KaTeXBlock 
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-zinc-600 dark:text-zinc-400 w-full max-w-3xl">
                  <div className="flex items-start gap-3 p-4 border border-zinc-200 dark:border-zinc-800 rounded-lg bg-zinc-50/50 dark:bg-zinc-800">
         ...
         <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden">
             <div className="bg-zinc-50 dark:bg-zinc-800 p-6 border-b border-zinc-200 dark:border-zinc-800">
               <h3 className="text-xl font-bold text-zinc-900 dark:text-white flex items-center gap-2">
                  <Lightbulb size={24} className="text-primary-400"/> 后期实操视角：这公式意味着什么？
               </h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-zinc-800">
               
               <div className="p-6 space-y-4">
                  <h4 className="text-lg font-bold text-primary-500 dark:text-cyan-400">关于 K-Weighting</h4>
               ...
               <div className="p-6 space-y-4">
                  <h4 className="text-lg font-bold text-emerald-600 dark:text-emerald-400">关于 Gating (门限)</h4>
                  <div className="text-sm text-zinc-700 dark:text-zinc-300 space-y-3">
                     <p>Gating 对后期来说意味着 <strong className="text-zinc-900 dark:text-white">“安静不算数”</strong>。</p>
                     <ul className="list-disc pl-5 space-y-2 text-zinc-600 dark:text-zinc-400">
         ...
         {/* Summary Table */}
         <div className="bg-zinc-100 dark:bg-zinc-800 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
            <div className="p-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-800">
               <h3 className="font-bold text-zinc-900 dark:text-white">RMS vs LUFS 核心差异</h3>
            </div>
            <table className="w-full text-left text-sm">
                <thead className="bg-zinc-100 dark:bg-zinc-900 text-zinc-600 dark:text-zinc-400">
                   <tr>
                      ...
                      <th className="p-4 text-primary-600 dark:text-cyan-400">LUFS (响度)</th>
                   </tr>
                </thead>
                <tbody className="divide-y divide-zinc-200 dark:divide-zinc-700 text-zinc-700 dark:text-zinc-300">
                  <tr>
                     ...
                     <td className="p-4 text-red-600 dark:text-red-400">❌ 无 (低频占优)</td>
                     <td className="p-4 text-emerald-600 dark:text-emerald-400">✅ K-weighting (人耳曲线)</td>
                  </tr>
                  <tr>
                     <td className="p-4 font-bold">安静段处理</td>
                     <td className="p-4 text-red-600 dark:text-red-400">❌ 平均值被拉低</td>
                     <td className="p-4 text-emerald-600 dark:text-emerald-400">✅ Gating (自动剔除)</td>
                  </tr>
                  <tr>
                     <td className="p-4 font-bold">主观听感</td>
                     <td className="p-4">差</td>
                     <td className="p-4 text-emerald-600 dark:text-emerald-400">高度一致</td>
                  </tr>
               </tbody>
            </table>
         </div>
