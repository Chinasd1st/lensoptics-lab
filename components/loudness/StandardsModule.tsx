   ...
   return (
      <div className="max-w-5xl mx-auto space-y-10 pb-12">
         <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-white mb-2">交付标准速查表</h2>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm">选择错误的响度标准会导致平台强制压缩音量（惩罚性衰减），或因电平过低导致用户听不清。</p>
         </div>

         {/* 1. Broadcast & Film (Strict) */}
         <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-lg">
            <div className="bg-zinc-800/50 p-4 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
               <Radio className="text-emerald-600 dark:text-green-400"/> 
               <h3 className="font-bold text-zinc-900 dark:text-white">1. 影视 / 广播 (最严格)</h3>
            </div>
            <div className="p-0">
         ...
         <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-lg">
            <div className="bg-zinc-800/50 p-4 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
               ...
               <h3 className="font-bold text-zinc-900 dark:text-white">2. 网络视频 (最常用)</h3>
            </div>
            <div className="p-0">
               <table className="w-full text-left text-xs text-zinc-600 dark:text-zinc-400">
                   <thead className="bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-200">
         ...
         <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden shadow-lg">
            <div className="bg-zinc-800/50 p-4 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
               <Smartphone className="text-primary-400"/> 
               <h3 className="font-bold text-zinc-900 dark:text-white">3. 短视频 / 手机端</h3>
            </div>
            <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
               <div>
                  <div className="text-4xl font-black text-primary-600 dark:text-primary-400 mb-2 font-mono">-13 ~ -15 <span className="text-base text-zinc-500 dark:text-zinc-400 font-bold">LUFS</span></div>
               ...
               <div className="bg-zinc-100 dark:bg-zinc-800 p-4 rounded border border-zinc-200 dark:border-zinc-800">
                  <h4 className="text-xs font-bold text-zinc-900 dark:text-white mb-2">混音建议：</h4>
