   ...
   return (
      <div ref={containerRef} className="h-screen bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200 font-sans overflow-y-auto no-scrollbar transition-colors duration-300">
         ...
         <div ref={contentRef} className="max-w-7xl mx-auto p-8 lg:p-12 space-y-12 min-h-screen">
            ...
            <div className="bg-slate-950 border-t border-slate-800 p-4 shrink-0 z-20">
               <div className="text-center text-slate-600 text-xs font-mono space-y-1">
                  ...
                  <div className="flex justify-center items-center gap-4 opacity-60 hover:opacity-100 transition-opacity">
                     <span className="flex items-center gap-1">
                        本页总阅读量 <span id="busuanzi_page_pv" className="font-bold text-slate-500">...</span> 次
                     </span>
                     <span className="w-px h-3 bg-slate-700"></span>
                     <span className="flex items-center gap-1">
                        本页总访客数 <span id="busuanzi_page_uv" className="font-bold text-slate-500">...</span> 人
                     </span>
                  </div>
               </div>
            </div>
